// ============================================================
// APP SHELL — sidebar + main content wrapper
// Every protected page is rendered inside this shell.
// ============================================================
import { useState } from 'react'
import { NavLink, Outlet } from 'react-router-dom'
import {
  LayoutDashboard, Users, Briefcase, Upload,
...
const NAV = [
  { to: '/dashboard',   label: 'Dashboard',   icon: LayoutDashboard, roles: ['super_admin','admin','interviewer'] },
  { to: '/candidates',  label: 'Candidates',  icon: Users,           roles: ['super_admin','admin','interviewer'] },
  { to: '/jobs',        label: 'Jobs',         icon: Briefcase,       roles: ['super_admin','admin'] },
  { to: '/upload',      label: 'Upload',       icon: Upload,          roles: ['super_admin','admin'] },
